			...
			<div class="col-sm-10 offset-sm-1">
				...
				<div class="info-form"><br>
					...
					<fieldset class="form-group row">
						...
						<div class="col-sm-8">
							<label for="Laki-laki">
								<?= form_radio('gender', 'Laki-laki', set_radio('gender', 'Laki-laki'), 'id="Laki-laki" class="form-check-inline"'); ?>
								Laki-laki
							</label><br>
							<label for="Perempuan">
								<?= form_radio('gender', 'Perempuan', set_radio('gender', 'Perempuan'), 'id="Perempuan"  class="form-check-inline"'); ?>
								Perempuan
							</label>
						</div>
					</fieldset>
